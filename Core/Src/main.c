...
/* AD9833 on SPI2; symbol hspi1 matches ad9833.c */
...
int main(void)
{
  ...
  MX_ADC1_Init();
  MX_ADC2_Init();
    /* AD9833: SPI2 PB13/14/15 (FSYNC PA4). ADC1 CH2 = PA1 (Vin). */
  MX_SPI1_Init();
  AD9833_Init();
  Imp_Init();
  /* UART_Comm_Init(&huart2); */  /* uncomment once UART is configured in CubeMX */
  /* USER CODE END 2 */
